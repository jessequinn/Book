...
\maketitle
\tableofcontents
\include{content/Capítulo_1}
\include{content/Capítulo_2}
\include{content/Capítulo_3}
\include{content/Capítulo_4}
\include{content/Capítulo_5}
\include{content/Capítulo_6}
\include{content/Capítulo_7}
\include{content/Capítulo_8}
\include{content/Capítulo_9}
\end{document}